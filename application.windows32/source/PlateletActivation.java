...
public void PlateletMechanics() {
   ...
   public void controlSetup() {
       ...
       Group group_simulation = controlP5.addGroup("Simulation");
    {
           ...
           controlP5.addRadio("obstacleFlowSimulation").setGroup(group_simulation).setSize(39, 18).setPosition(px, py += oy)
             .addItem("Flow obstacle simulation",0)
             .activate(obstaclesSimulation);
   ...
   public void particleCollision(int i) {
       allowCollision = i;
   }
   ...
   public void obstacleFlowSimulation(int i){
...
class Rbc extends BloodCont{
  ...
  public void settings() {  size(850, 200,P2D); }
